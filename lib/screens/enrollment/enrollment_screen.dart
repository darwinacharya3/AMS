...
//         onLoadingStateChanged: _handleLoadingState,
//         onError: _handleError,
//         onSignupSuccess: _handleSignupSuccess,  // Add signup success handler
//       );
...
// class _EnrollmentScreenState extends State<EnrollmentScreen> {
//   WebViewController? _controller;  // Make nullable instead of late
//   bool _isLoading = true;
//   String _errorMessage = '';
...
//   Future<void> _initializeWebView() async {
//     _controller = await WebViewControllerService.initialize(
//       onLoadingStateChanged: _handleLoadingState,
//       onError: _handleError,
//     );
//   }
