...
//     try {
//       // Get full response from API (important: get raw data to access qr_code at root level)
//       final response = await MembershipCardService.getRawMembershipData();
      
//       developer.log('Full API response received, processing data...');

//       // Check if response has qr_code at root level
//       if (response.containsKey('qr_code')) {
//         _qrCode = response['qr_code'];
//         developer.log('QR code found in response: ${_qrCode?.substring(0, 50)}...');
//       }
...
//         _isLoading = false;
//       });
//       developer.log('Error loading membership data: $e');
//     }
//   }
...
//   try {
//     // Debug the formData
//     debugPrint('Form data received: $formData');
    
//     // Submit the form data directly (no need to modify it)
//     final success = await MembershipCardService.submitMembershipApplication(formData);
