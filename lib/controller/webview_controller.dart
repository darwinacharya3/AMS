...
//   required Function() onSignupSuccess,
// }) {
//   bool hasProcessedSuccess = false; // Flag to prevent double processing
...
//         await _captureEmailAndCookiesAfterSuccess(controller); // Updated method call
//         onSignupSuccess();
//       }
//     },
...
// // Add this to your WebViewControllerService class

// static Future<void> _captureEmailAndCookiesAfterSuccess(WebViewController controller) async {
//   try {
//     // Existing email capture code 
//     final String jsEmailCode = '''
//       (function() {
//         try {
//           const email = document.querySelector('input[type="email"]')?.value || 
//                        document.querySelector('input[name="email"]')?.value ||
...
//     final emailResult = await controller.runJavaScriptReturningResult(jsEmailCode);
//     final email = emailResult.toString().replaceAll('"', '');
...
//     await SecureStorageService.extractAndSaveCookiesFromWebView(controller);
    
//   } catch (e) {
//     debugPrint('Error capturing user data: $e');
//   }
// }
