...
//           await controller.runJavaScript('''
//             console.log('Page loaded, running custom JS for Career');
            
//             // Step 1: First hide navigation elements
//             try {
//               // Try multiple selectors to hide navigation elements
//               const navElements = document.querySelectorAll('nav, .navbar, header, .header');
//               console.log('Found ' + navElements.length + ' navigation elements');
//               navElements.forEach(el => {
//                 console.log('Hiding nav element: ' + el.tagName);
//                 el.style.display = 'none';
//               });
//             } catch (e) {
//               console.error('Error hiding navigation: ' + e);
//             }
...
//                 } else {
//                   console.error('Could not find career tab');
//                   // Fallback to data-bs-target if available
//                   document.querySelector('a[data-bs-target="#nav-performance"]')?.click();
//                 }
                
//                 // Hide profile sections
//                 const profileSections = document.querySelectorAll('.profile, .profile-section, .user-profile');
